...
def inc_subseqs(s):
    ...
    def subseq_helper(s, prev):
        if not s:
            ...
            a = subseq_helper(s[1:], prev) # give up s[0], the lower boundary is still prev
            b = subseq_helper(s[1:], s[0]) # include s[0], the lower boundary becomes s[0]
...
class Keyboard:
    ...
    def __init__(self, *args):
        self.buttons = {}
        for button in args: # use 'args' instead of '*args'
    ...
    def make_counter():
        ...
        def counter(word):
            ...
            if word == 'global-count':
                ...
                return 'Can not recognize inputs like this!'
        return counter
    return make_counter
...
def deep_len(lnk):
    ...
    # The given solution is above, I have to admit that I don't figure out this.
    # The given solution assumes that *lnk* can also be not an instance of Link, while I assume that *lnk* must be an instance of Link(or Link.empty)
